...
struct QuestionsData {
    ...
    var questions = [
        ...
        Question(q: "Что такое горизонт событий?", a: ["Ближайшие планы по освоению космоса человечеством", "Граница Вселенной, за которой не существует объектов", "Границы черной дыры, за пределы которой не может вырваться никакой объект или излучение", "Граница видимой с Земли части космоса"], correctAnswer: "Границы черной дыры, за пределы которой не м ожет вырваться никакой объект или излучение"),
